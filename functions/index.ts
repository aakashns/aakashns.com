...
const homepage = withLayout(/* HTML */ `
  <div class="max-w-2xl mb-40 mx-4 mt-8 lg:mx-auto">
    ...
    <p>
      I'm the founder and CEO of <a href="https://jovian.com">Jovian</a>, a learning platform for software development
      and data science. I've previously worked as a Software Engineer at Twitter and I hold a bachelor's degree in
      Computer Science from the Indian Institute of Technology Bombay. Online courses I've taught have over 10 million
